...
def page_model_performance_body():
    ...
    st.markdown(
        ...
        Not Converted       0.94      0.96      0.95       948
            Converted       0.94      0.91      0.93       627
        ...
        **Interpretation:**
        - The model achieves 94% accuracy on the test set
        - Excellent precision (94%) for both classes minimises false alarms
        - High recall (91%) for Converted class ensures few missed opportunities
        - Balanced performance across both classes indicates robust learning
        """
    )
